...
class UtilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utility" do
    assert_difference('Utility.count') do
      post utilities_url, params: { utility: { company_id: @utility.company_id, note: @utility.note } }
    end
  ...
  test "should update utility" do
    patch utility_url(@utility), params: { utility: { company_id: @utility.company_id, note: @utility.note } }
